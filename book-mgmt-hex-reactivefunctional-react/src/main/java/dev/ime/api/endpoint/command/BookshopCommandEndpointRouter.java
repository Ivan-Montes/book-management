...
@Configuration
public class BookshopCommandEndpointRouter {

	private final UriConfigProperties uriConfigProperties;
	private final CommandEndpointPort commandEndpointPort;
	
	public BookshopCommandEndpointRouter(UriConfigProperties uriConfigProperties,
			@Qualifier("bookshopCommandEndpointHandler")CommandEndpointPort commandEndpointPort) {
		super();
	...
	@RouterOperations({
		@RouterOperation(
				...
				beanClass = BookshopCommandEndpointHandler.class, 
				beanMethod = "create",
	...
	@Bean
	RouterFunction<ServerResponse> bookshopCommandEndpointRoutes() {

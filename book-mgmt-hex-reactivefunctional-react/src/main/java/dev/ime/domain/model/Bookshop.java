...
public class Bookshop {
	...
	public Bookshop(UUID bookshopId, String name, Set<BookBookshop> books, LocalDateTime creationTimestamp,
	...
	public UUID getBookshopId() {
		return bookshopId;
	}

	public void setBookshopId(UUID bookshopId) {
		this.bookshopId = bookshopId;
	}

...
public class AuthorQueryEndpoint implements QueryEndpointPort<AuthorDto> {
	...
	@Override
	public Mono<PaginatedResult<AuthorDto>> getAll(
		...
		return Mono.just(paginationUtils.createPaginationDto(page, size, sortBy, sortDir, attrsSet, GlobalConstants.AUTHOR_ID))
    ...
    @GetMapping("/{id}")
	@Override
	public Mono<ResponseEntity<AuthorDto>> getById(@PathVariable UUID id) {
